...
export const searchApiPayload = (username:string) => {
    return {
        LoginType: "1",
        isEmployee: "0",
        isGridActionRefresh: false,
        text:`%24inlinecount=allpages&%24format=json&gridName=Users&userID=10aec560-b9d7-44ad-9d9b-4e44c433fe75&%24filter=startswith(tolower(UserName)%2C'${username}')`
